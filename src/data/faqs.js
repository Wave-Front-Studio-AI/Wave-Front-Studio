// The published question-and-answer pairs, kept here rather than inside a page
// component so the /faqs/ page, the free-setup page, and the site assistant all
// read one copy of them.

export const siteFaqs = [
  [
    'What services does Wavefront Studio offer?',
    'We offer a full range of digital services including website development, mobile app development, SEO, digital marketing, social media strategy, graphic design, AI chatbot integration, live product visualizers, and custom web calculators. We also build AI-powered automation systems and handle any custom digital project based on your requirements.',
  ],
  [
...
export const freeSetupFaqs = [
  ...
  [
    'Why only five?',
    'Because setup is the part that takes our team’s time rather than software’s. We can onboard five businesses properly in a quarter alongside existing client work. Taking ten would mean doing all ten badly, which helps nobody.',
  ],
  [
